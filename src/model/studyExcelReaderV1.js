...
function readV1StudyBasicSettings(workbook) {
    return StudyBasicSettings.createV1(
        ...
        readCell(workbook, V1.general.basic.length),
        readCell(workbook, V1.general.basic.requireReactions),
        readCell(workbook, V1.general.basic.requireComments),
        readCell(workbook, V1.general.basic.requireIdentification),
    );
}

function readV1StudyUserInterfaceSettings(workbook) {
    return StudyUserInterfaceSettings.createV1(
...
function readV1StudyAdvancedSettings(workbook, basicSettings) {
    const commentsEnabled = (basicSettings.requireComments !== "disabled"),
          genCompletionCode = readCell(workbook, V1.general.advanced.genCompletionCode);

    return StudyAdvancedSettings.createV1(
        (commentsEnabled ? readCell(workbook, V1.general.advanced.minimumCommentLength) : 0),
...
function readV1StudyPagesSettings(workbook) {
    return StudyPagesSettings.createV1(
...
export function readV1Study(workbook) {
    ...
    const basicSettings = readV1StudyBasicSettings(workbook),
          uiSettings = readV1StudyUserInterfaceSettings(workbook),
          advancedSettings = readV1StudyAdvancedSettings(workbook, basicSettings),
          pagesSettings = readV1StudyPagesSettings(workbook);
